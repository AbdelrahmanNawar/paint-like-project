...
public class Line extends Shape {
    ...
    public Line(Point startPoint, Point endPoint, Color outColor, Color inColor) {
    ...
    public void draw(Graphics g) {
       ...
       ((Graphics2D) g).drawLine(getStartPoint().x,getStartPoint().y,getEndPoint().x,getEndPoint().y);
    }
