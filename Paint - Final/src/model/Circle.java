...
public class Circle extends Shape {
    ...
    public Circle(Point startPoint, Point endPoint, Color outColor, Color inColor) {
    ...
    public void draw(Graphics g) {
       ...
       ((Graphics2D) g).drawOval(getStartPoint().x,getStartPoint().y,getEndPoint().x,getEndPoint().y);
       ((Graphics2D) g).setColor(getInColor());
       ((Graphics2D) g).fillOval(getStartPoint().x,getStartPoint().y,getEndPoint().x,getEndPoint().y);
    }

    @Override
    public boolean matchRegion(Point p) {
        
        Ellipse2D circle = new Ellipse2D.Double(getStartPoint().x,getStartPoint().y,getEndPoint().x,getEndPoint().y);
