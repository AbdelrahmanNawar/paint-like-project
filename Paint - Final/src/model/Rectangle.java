...
public class Rectangle extends Shape {
    ...
    public Rectangle(Point startPoint, Point endPoint, Color outColor, Color inColor) {
    ...
    public void draw(Graphics g) {
       ...
       ((Graphics2D) g).drawRect(getStartPoint().x,getStartPoint().y,getEndPoint().x - getStartPoint().x,getEndPoint().y - getStartPoint().y);
       ((Graphics2D) g).setColor(getInColor());
       ((Graphics2D) g).fillRect(getStartPoint().x,getStartPoint().y,getEndPoint().x - getStartPoint().x,getEndPoint().y - getStartPoint().y);
    }

    @Override
    public boolean matchRegion(Point p) {
        Ellipse2D rectangle = new Ellipse2D.Double(getStartPoint().x,getStartPoint().y,getEndPoint().x - getStartPoint().x,getEndPoint().y - getStartPoint().y);
